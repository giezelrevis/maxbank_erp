				    ...
				    success: function(msg){						
						...
						$('#applicationDate').val($(msg).find('#loan-application-date').html());
                                                if ($(msg).find('#loan-application-status').html() != '') {
                                                    if ($(msg).find('#loan-application-status').html() != 'Approved by Credit Com') {
        ...
        <content tag="main-actions">
            <ul>
                ...
                <g:elseif test="${module == "loanReschedule" && loanInstance?.loanPerformanceId.id == 1 && loanInstance?.status?.id == 4}">
                    ...
                    <li><a href="#" onclick="rescheduleCallAlertify();" >Saves Reschedule</a></li>    
                ...
                <script>
                    function rescheduleCallAlertify(){
                      ...
                      alertify.confirm(AppTitle,"Are you sure you want to Reschedule this Loan?",
                            function(){
                              checkIfAllowed('LON01300', 'form#loan-form', 'Update branch XXX.', null); // params: policyTemplate.code, form to be saved
                            },
                            function(){
                              alertify.error('Loan Reschedule Canceled!');
                            });
                    }
                    ...
                    function restructureCallAlertify(){
                        alertify.confirm(AppTitle,"Are you sure you want to Restructure this Loan?",
                            function(){
                              checkIfAllowed('LON01400', 'form#loan-form', 'Update branch XXX.', null); // params: policyTemplate.code, form to be saved
                            },
                            function(){
                              alertify.error('Loan Restructure Canceled!');
                            });
